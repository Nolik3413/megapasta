...
local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/Nolik3413/ff/main/ff")).icons
end)
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "OS HUB"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			Name = "UI спрятан",
			Content = "Нажмите RightShift чтобы открыть снова UI",
			Time = 5
		})
